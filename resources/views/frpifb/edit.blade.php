	...
	<div class="col-lg-12">
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S1'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S1s'])}}">
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S2'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S2s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S3'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S3s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S4'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S4s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-header with-border">
					<h3 class="box-title">
						Las siguientes pregunras están relacionadas con las decisiones y el control que le permite su trabajo.
					</h3>
				</div>
				...
				<div class="box-body">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>Mi trabajo me permite aprender cosas nuevas</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S5'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S5s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S6'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S6s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S7'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S7s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S8'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S8s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-body">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>Mi jefe me conumica a tiempo la información relacionada con el trabajo</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
						...
						<tr>
							...
							<td>Mi jefe me ayuda a progresar en mi trabajo</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
						...
						<tr>
							...
							<td>Mi feje ayuda a solucionar los problemas que se presentan en el trabajo</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S9'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S9s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-body">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>En mi grupo de trabajo me tratan de manera respetuosa</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S10'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S10s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S11'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S11s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S12'])}}">Submit</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S12s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<form method="POST">
				...
				<div class="box-body">
					...
					<table class="table table-bordered" id="pv1" style="display: {{old('pv1') == 'SI' ? 'inline-table' : 'none'}};">
						...
						<tr>
							...
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p89') == '4' ? 'checked' : ''}} name="p89" value="3" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p89') == '4' ? 'checked' : ''}} name="p89" value="2" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p89') == '4' ? 'checked' : ''}} name="p89" value="1" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p89') == '4' ? 'checked' : ''}} name="p89" value="0" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p97') == '4' ? 'checked' : ''}} name="p97" value="0" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p97') == '3' ? 'checked' : ''}} name="p97" value="1" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
							...
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p97') == '1' ? 'checked' : ''}} name="p97" value="3" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
							<td style="text-align: center; padding: 0;">
								<label style="margin:0; width: 100%;">
									<input type="radio" {{old('p97') == '0' ? 'checked' : ''}} name="p97" value="4" style="margin-top: 10px; margin-bottom: 10px;">
								</label>
							</td>
						</tr>
					</table>
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" id="btnPv1" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S13'])}}" style="display: {{old('pv1') == 'SI' ? 'inline-table' : 'none'}}">
						Continuar
					</button>

					@if ($errors->any())
					<button type="submit" class="btn btn-warning pull-right" formaction="{{route('frpifb.update', [$user->id, $frpifb, 'S13s'])}}">
						Continuar de todas formas
					</button>
					@endif
				</div>
		...
		<div class="box box-primary">
			<div class="box-body">
				<div class="form-group {{$errors->has('cedula') ? 'has-error' : ''}}">
					...
					id="inputCedula"
					placeholder="Cédula"
					value="{{old('cedula', $frpifb->cedula)}}"
					readonly="true">
				...
				<div class="form-group {{$errors->has('fecha_cuestionario') ? 'has-error' : ''}}">
					...
					<div class="input-group date">
						...
						value="{{old('fecha_cuestionario', $frpifb->fecha_cuestionario ? $frpifb->fecha_cuestionario->format('m/d/Y') : null)}}"
						readonly="true">
					</div>
