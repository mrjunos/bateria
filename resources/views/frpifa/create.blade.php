<div class="modal fade" id="frpifaModal" tabindex="-1" role="dialog" aria-labelledby="frpifaModalLabel">
	<form role="form" method="POST" action="{{route('frpifa.store', $user->id)}}">
		@csrf
				...
				<div class="modal-body">
					...
					<div class="form-group {{$errors->has('fecha_cuestionario') ? 'has-error' : ''}}">
						...
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right" id="frpifaDatepicker" name="fecha_cuestionario" value="{{old('fecha_cuestionario')}}">
						</div>
